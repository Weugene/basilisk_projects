...
pip${pyver_short} install pandas plotly orca sklearn networkx kaleido statsmodels tsmoothie psutil requests --user
cd $HOME/opt/Python-${pyver}/lib/python${pyver_short}_/site-packages/
mv numpy numpy_
