...
//#define FILTERED
#include "../src_local/not-used/three-phase.h"
#include "../src_local/not-used/tension_three-phase.h"
#include "distance.h"
...
#define ADAPT_SCALARS {a, ga.x, ga.y, omega}
#define ADAPT_EPS_SCALARS {fErr, fErr, fErr, OmegaErr}
