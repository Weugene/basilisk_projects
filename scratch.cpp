...
pf[left]  = neumann(0.);
f[left]   = 1.0; //liquid
fiber[left] = 0; //fiber is fixed for any time. No need to set?
/**
...
fiber[right] = 0; //fiber is fixed for any time. No need to set?
...
field used for the inflow condition and set the initial liquid level
and velocity field. */
