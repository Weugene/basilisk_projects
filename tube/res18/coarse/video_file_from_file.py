...
contour2Display.ScaleFactor = 0.3329599454085324
contour2Display.SelectScaleArray = 'f'
contour2Display.GlyphType = 'Arrow'
contour2Display.GlyphTableIndexArray = 'f'
contour2Display.GaussianRadius = 0.01664799727042662
...
if not noPic:
    ...
    #     cylinder1 = FindSource('Contour2')
        bounds = contour2.GetDataInformation().GetBounds()
        print("bounds=",bounds)
...
# show data in view
contour2Display_1 = Show(contour2, spreadSheetView1)
