...
tube_bp_from_dumppvd = PVDReader(FileName='/Users/weugene/basilisk/work/tube/dump2pvd_compressed.pvd')
...
cylinder1Display = Show(cylinder1, renderView2, 'GeometryRepresentation')
...
# ----------------------------------------------------------------
# Show(clip2, renderView2, 'GeometryRepresentation')
Hide(cylinder1,renderView2)
Render()

SaveScreenshot( "MY_TEST_parallel.png", renderView2,
